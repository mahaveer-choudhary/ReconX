...
async def ssh_bruteforce(hostname, username, password, port, found_flag):
    ...
    try:
        ...
        print(
            f"{Fore.BLUE}[Attempt]{Fore.LIGHTMAGENTA_EX} target {Fore.RESET}{hostname} - {Fore.LIGHTMAGENTA_EX}login:{Fore.RESET}{username} - {Fore.LIGHTMAGENTA_EX}password:{Fore.RESET}{password}{Fore.RESET}")
